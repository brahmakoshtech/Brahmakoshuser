      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col items-center">
        ...
        >
          ...
          <motion.img
            ...
            alt="Brahmakosh Logo"
            className="w-48 h-48 min-[360px]:w-56 min-[360px]:h-56 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-contain relative z-10"
            animate={{
              rotate: [0, 5, -5, 0],
              scale: [1, 1.05, 1],
            }}
        ...
        {/* Main Title - Fixed for 320px screens */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.2 }}
          className="text-center mb-3 sm:mb-4 w-full px-2"
        >
          <h1 className="text-3xl min-[360px]:text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold mb-2 leading-tight break-words">
            <motion.span
        ...
        >
          <p className="text-base min-[360px]:text-lg sm:text-xl md:text-2xl font-medium bg-gradient-to-r from-gray-700 via-gray-800 to-gray-700 bg-clip-text text-transparent">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="text-center mb-4">
              ...
              <motion.a
                ...
                className="inline-flex items-center justify-center gap-2 text-orange-600 hover:text-orange-700 transition-colors font-medium text-sm min-[360px]:text-base sm:text-lg group"
